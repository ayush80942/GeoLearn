...
export function QuizModal({ video, onClose, onPass }: QuizModalProps) {
  ...
  const questions = [
    {
      question: 'Which of the following best describes the main focus of this video?',
      options: [
        video.learningObjectives[0],
    ...
    {
      question: `What category of geography does "${video.title}" belong to?`,
      options: [
        video.category,
    ...
    {
      question: 'Who is the instructor of this video?',
      options: [
        video.instructor,
        'Dr. Emily Parker',
        'Prof. David Brown',
